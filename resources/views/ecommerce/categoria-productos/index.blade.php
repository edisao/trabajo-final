        ...
        <div class="col-sm-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <strong>{{ trans('ecommerce.categoriaProductos') }}</strong>
                </li>
            </ol>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12 white-bg">
                <div class="wrapper wrapper-content">
                    <p>
                        <a href="{{ route('categoriaProductos.create') }}" class="btn btn-white btn-bitbucket">
...
<script>
    ...
    $(function() {
        ...
        var titleExportDocument = "{{ trans('ecommerce.categoriaProductos') }}";
        $("#tableData").DataTable({
            'responsive': true,
            'bAutoWidth': false,
            'lengthChange': true,
            ...
            'pageLength': 50,
            'ajax':"{{route('categoriaProductos.data')}}",
            'buttons': [{
                    extend: 'csv',
