...
@section('page_content')
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-12">
            <h2>{{ trans('ecommerce.marca') }}</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="{{ route('dashboard.index') }}">{{ trans('labels.inicio') }}</a>
                </li>
                <li class="breadcrumb-item">
                    <a href="{{ route('marcaProductos.index') }}">{{ trans('ecommerce.marca') }}</a>
                </li>
        ...
        <div class="row">
            <div class="col-lg-12 white-bg">
                <div class="wrapper wrapper-content">
                    ...
                    <form role="form" name="FormRegistro" id="FormRegistro" action="{{ route('marcaProductos.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
