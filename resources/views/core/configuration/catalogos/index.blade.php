...
@section('page_title', trans('labels.catalogos'))
        ...
        <div class="col-sm-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <strong>{{ trans('labels.catalogos') }}</strong>
                </li>
            </ol>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12 white-bg">
                <div class="wrapper wrapper-content">
                    <p>
                        <a href="/catalogos/create" class="btn btn-white btn-bitbucket">
...
<script>
    ...
    $(function() {
        ...
        var titleExportDocument = "{{ trans('labels.catalogos') }}";
        $("#tableData").DataTable({
            'responsive': true,
            'bAutoWidth': false,
            'lengthChange': true,
            ...
            'columns':[
                ...
                {data:'nombre'},
                {data:'descripcion'},
                {data:'opc', name: 'action', orderable:false, searchable:false, className: 'text-right', width: 165},
            ]
        });
